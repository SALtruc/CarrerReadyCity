...
type Profile = { avatar: number; year: string; program: string; accessCode: string };
type GameState = {
...
const initial = { profile:{avatar:-1,year:'',program:'',accessCode:''}, visited:[], scores:{R:0,I:0,A:0,S:0,E:0,C:0}, answers:{} };
